...
Nested table level 1 columns:
1. Bank (e.g. Santander, Revolut, Monzo)
2. Action (Sync, Disconnect)

Nested Table level 2 columns:
1. Account Name (e.g. Everyday saver)
2. Account type (e.g. Saving, Transaction, Credit Card)
3. Last Sync
4. Action (Sync, Disconnect)
