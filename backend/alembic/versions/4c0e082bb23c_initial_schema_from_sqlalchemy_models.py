...
def upgrade() -> None:
    ...
    op.drop_table("truelayer_oauth_state")
    ...
    op.drop_table("truelayer_connections")
    ...
    op.drop_table("gmail_parse_statistics")
    op.drop_index(
    ...
    op.drop_table("subcategory_mappings")
    op.drop_index(
        "idx_ab_matches_order", table_name="truelayer_amazon_business_matches"
    )
    op.drop_table("truelayer_amazon_business_matches")
    op.drop_index(
    ...
    op.drop_table("truelayer_enrichment_jobs")
    ...
    op.drop_table("normalized_subcategories")
    ...
    op.drop_table("truelayer_card_balance_snapshots")
    op.drop_index(
    ...
    op.drop_table("truelayer_import_progress")
    ...
    op.drop_table("gmail_processing_errors")
    ...
    op.drop_table("gmail_transaction_matches")
    ...
    op.drop_table("truelayer_card_transactions")
    op.drop_index(
    ...
    op.drop_table("gmail_sender_patterns")
    ...
    op.drop_table("truelayer_import_jobs")
    op.drop_index(
    ...
    op.drop_table("gmail_merchant_statistics")
    ...
    op.drop_table("gmail_merchant_aliases")
