...
def get_suggestion_for_transaction(transaction_id):
    ...
    if category_classifications:
        ...
        most_common = counter.most_common(1)[0]
        classification, count = most_common
        confidence = (count / len(category_classifications)) * 0.7  # Reduce confidence for category-only match
    ...
    if range_classifications:
        ...
        most_common = counter.most_common(1)[0]
        classification, count = most_common
        confidence = (count / len(range_classifications)) * 0.5  # Lower confidence for amount-only match
...
def get_category_classification_patterns():
    ...
    for category, stats in category_stats.items():
        ...
        if total > 0:
            ...
            most_common = 'essential' if stats['essential'] > stats['discretionary'] else 'discretionary'
