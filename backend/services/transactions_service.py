...
def get_all_transactions() -> list:
    ...
    all_transactions = db_transactions.get_all_truelayer_transactions_with_enrichment() or []
...
def update_huququllah_classification(transaction_id: int, classification: str) -> dict:
    ...
    if classification not in ['essential', 'discretionary', None]:
        raise ValueError('Invalid classification. Must be "essential", "discretionary", or null')

    success = db_transactions.update_transaction_huququllah(transaction_id, classification)
...
def set_primary_enrichment_source(transaction_id: int, source_type: str, source_id: int = None) -> dict:
    """
    ...
    success = db_transactions.set_primary_enrichment_source(transaction_id, source_type, source_id)
